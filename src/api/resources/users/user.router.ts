...
import { getAllUsers, createUser, duplicatedUser, getUserByEmail, getUserById } from './user.controller';
...
userRouter.get('/:id', jwtAuthenticate, async ( req: Request, res: Response ) => {
...
userRouter.post('/', [userValidate, jwtAuthenticate], async ( req: Request, res: Response) => {
